...
DMA::DMA ( int priority)
{
    ...
    switch (channel) {
        case 0:
            GPDMA_Channel= LPC_GPDMACH0;
            break;
        case 1:
            GPDMA_Channel= LPC_GPDMACH1;
            break;
        case 2:
            GPDMA_Channel= LPC_GPDMACH2;
            break;
        case 3:
            GPDMA_Channel= LPC_GPDMACH3;
            break;
        case 4:
            GPDMA_Channel= LPC_GPDMACH4;
            break;
        case 5:
            GPDMA_Channel= LPC_GPDMACH5;
            break;
        case 6:
            GPDMA_Channel= LPC_GPDMACH6;
            break;
        case 7:
            GPDMA_Channel= LPC_GPDMACH7;
            break;
        default:
            GPDMA_Channel= LPC_GPDMACH0;
            break;
...
void DMA::trigger (TriggerType trig)
{
    if (trig==ALWAYS)
        ...
        dma_init_struct.DMA_DestPeripheral = trig;
}
